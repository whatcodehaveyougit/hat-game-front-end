...
export default function Dashboard() {
    ...
    useEffect(() => {
        fetch("https://git.heroku.com/sigurd-hat-game.git/games/")
        .then(res => res.json())
    ...
    function onTeamPost(newTeamName){
      fetch("https://git.heroku.com/sigurd-hat-game.git/teams/",{
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
    ...
    function onPlayerPost(newPlayerName){  
      fetch("https://git.heroku.com/sigurd-hat-game.git/players/", {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
    ...
    function addPlayerToState(player){
      ...
      function onCluePost(newClue){
        fetch("https://git.heroku.com/sigurd-hat-game.git/clues/", {
          method: 'POST',
          headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
    ...
    function getTeamsCurrentScore(){
      ...
      function onClueGuessed(clueId){ 
          fetch(`https://git.heroku.com/sigurd-hat-game.git/clues/${clueId}`, {
            method: 'PATCH',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
      ...
      function endOfTurn(){
        ...
        fetch(`https://git.heroku.com/sigurd-hat-game.git/teams/${selectedGame.teams[selectedGame.activeTeam].id}`, {
          method: 'PATCH',
          headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
          ...
          if (selectedGame.activeTeam + 1 === selectedGame.teams.length){
              fetch(`https://git.heroku.com/sigurd-hat-game.git/games/${selectedGame.id}`, {
                method: 'PATCH',
                headers: {
                  'Accept': 'application/json',
                  'Content-Type': 'application/json',
      ...
      function endOfRound(){   
        ...
        selectedGame.clues.forEach(clue => {
          fetch(`https://git.heroku.com/sigurd-hat-game.git/clues/${clue.id}`, {
            method: 'PATCH',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
